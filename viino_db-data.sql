...
--
-- Datos para la tabla `varietal`
--

LOCK TABLES `varietal` WRITE;
DELETE FROM `varietal`;
INSERT INTO `varietal` 
   (id, name )
VALUES
  (1, 'Blend'),
  (2, 'Chardonnay'),
...
INSERT INTO `products` 
   ( id, name, short_name, producer_id, year, type_id, price, description, location, altitude, soil, abv, breading, varietal_id, varietal_comp)
VALUES
...
--
-- Datos para la tabla `image` - para tener mas de una imagen por producto (alguna vez!)
--
