...
--
-- Estructura de la tabla `varietal`
--
...
CREATE TABLE `products` (
  ...
  CONSTRAINT `products_FK_1` FOREIGN KEY (`type_id`) REFERENCES `type` (`id`),
  CONSTRAINT `products_FK_2` FOREIGN KEY (`varietal_id`) REFERENCES `varietal` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `image` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `image_FK` FOREIGN KEY (`id`) REFERENCES `products` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
